  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Unlock achievements and claim bonuses for your progress and for growing your squad.
        </CardDescription>
      </CardHeader>
      <CardContent>
        <Tabs defaultValue="achievements">
          <TabsList className="grid w-full grid-cols-2">
            ...
            <TabsTrigger value="referrals">
              <GitBranch className="mr-2 h-4 w-4" /> Squad Referrals
            </TabsTrigger>
          </TabsList>
          ...
          <TabsContent value="referrals" className="mt-6">
            <p className="text-center text-muted-foreground">
              Referral claims feature coming soon!
            </p>
          </TabsContent>
        </Tabs>
      </CardContent>
