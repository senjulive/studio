...
export function ComprehensiveTradingBot({ className }: TradingBotProps) {
  ...
  const recentTrades = [
    { id: 1, type: 'buy', pair: 'BTC/USDT', amount: 0.001, price: 43250, profit: 12.34, time: '2 min ago' },
    { id: 2, type: 'sell', pair: 'BTC/USDT', amount: 0.001, price: 43280, profit: 8.76, time: '5 min ago' },
    { id: 3, type: 'buy', pair: 'ETH/USDT', amount: 0.05, price: 2650, profit: 15.23, time: '8 min ago' },
    { id: 4, type: 'sell', pair: 'BTC/USDT', amount: 0.001, price: 43290, profit: 11.45, time: '12 min ago' },
  ];
        ...
        <div className="flex items-center gap-4">
          <div className="relative">
            <div className={`w-16 h-16 rounded-full flex items-center justify-center ${
              isRunning ? 'bg-green-500/20 border-2 border-green-500/50' : 'bg-gray-500/20 border-2 border-gray-500/50'
            }`}>
                  ...
                  <div key={trade.id} className="flex items-center justify-between p-3 rounded-lg border">
                    <div className="flex items-center gap-3">
                      <Badge 
                        ...
                        className={trade.type === 'buy' ? 'bg-green-500/10 text-green-500' : 'bg-red-500/10 text-red-500'}
                      >
              ...
              <CardContent>
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    ...
                    <Badge variant="default" className="bg-green-500/10 text-green-500">Healthy</Badge>
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <Badge variant="default" className="bg-green-500/10 text-green-500">Live</Badge>
                  </div>
