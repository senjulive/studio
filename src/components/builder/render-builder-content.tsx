        ...
        <main className="relative z-10 flex flex-col min-h-dvh">
          ...
          <div className="flex-1 flex flex-col justify-center items-center text-center px-6 py-12">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="text-left">
                    ...
                    <p className="text-sm text-muted-foreground">
                      24/7 AI-powered profit generation
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="w-full max-w-md space-y-4 mb-8">
              <Button
                asChild
                className="w-full h-14 text-lg font-bold bg-gradient-to-r from-primary to-secondary hover:scale-105 transition-all duration-300 electric-glow"
              >
                <Link href="/login">
              ...
              <Button
                asChild
                variant="outline"
                className="w-full h-14 text-lg font-bold border-primary/50 hover:bg-primary/10 transition-all duration-300"
              >
            ...
            <div className="mobile-card w-full max-w-md">
              <div className="grid grid-cols-3 gap-6 text-center">
                ...
                <div>
                  <div className="text-xl font-black bg-gradient-to-r from-secondary to-accent bg-clip-text text-transparent">
                    250K+
                  </div>
